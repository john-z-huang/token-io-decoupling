...
- [Coding Delegation State Record Worker Boundary](delegation-state-record-worker-boundary_zh_cn.md) — 定位 Worker 快照和记录访问边界。
...
- [Coding Child Lifecycle](delegation-child-dispatch-lifecycle_zh_cn.md) — 定位子 Agent 生命周期字段归属。
