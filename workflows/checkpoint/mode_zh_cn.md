...
1. 加载[状态记录 reference](../../references/coding/layer-01-fundamental-concepts/delegation-state-record_zh_cn.md)和[模式/数量门禁 reference](../../references/coding/layer-01-fundamental-concepts/delegation-mode-count-gate_zh_cn.md)。如果已发布模式分配了子代理，还要加载[子代理派发/生命周期 reference](../../references/coding/layer-01-fundamental-concepts/delegation-child-dispatch-lifecycle_zh_cn.md)。
