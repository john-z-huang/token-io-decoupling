...
1. Read [`workflows/coding.md`](workflows/coding.md), then follow its instruction to load exactly one mode workflow:
   - [`workflows/exist-workflow/coding-single-agent.md`](workflows/exist-workflow/coding-single-agent.md) when delegation is forbidden or unnecessary;
   - [`workflows/exist-workflow/coding-multi-agent.md`](workflows/exist-workflow/coding-multi-agent.md) only when multiple agents are explicitly requested or concretely required and allowed.
