...
1. 读取 [`workflows/coding_zh_cn.md`](workflows/coding_zh_cn.md)，再按其中的指引只加载一个模式工作流：
   - 禁止委派或没有必要委派时读取 [`workflows/exist-workflow/coding-single-agent_zh_cn.md`](workflows/exist-workflow/coding-single-agent_zh_cn.md)；
   - 只有用户明确要求多个代理，或任务确实需要且允许多个代理时，才读取 [`workflows/exist-workflow/coding-multi-agent_zh_cn.md`](workflows/exist-workflow/coding-multi-agent_zh_cn.md)。
