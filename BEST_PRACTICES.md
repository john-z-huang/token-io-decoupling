...
5. In this repository, have Documentation/Comments & Git Operations run `python3 scripts/check-multilingual-docs.py`, `git diff --check`, and `git status --short` for the documentation/Git scope.
